        ...
        try:
            while not self.stop_event.is_set():
                try:
                    ...
                    conn.settimeout(60.0)  # Increase timeout for large file transfers
                            ...
                            with open(self.filepath, 'rb') as f:
                                ...
                                while not self.stop_event.is_set():
                                    ...
                                    try:
                                        ...
                                        self.logger.log(f"Timeout sending encrypted chunk at {self.sent_bytes}/{self.filesize} bytes.")
                            ...
                            with open(self.filepath, 'rb') as f:
                                ...
                                while not self.stop_event.is_set():
                                    ...
                                    try:
                                        ...
                                        self.logger.log(f"Timeout sending chunk at {self.sent_bytes}/{self.filesize} bytes.")
                                        # Don't break, continue trying to send
                                        time.sleep(0.1)
                                        continue
                                    # Add a small delay to prevent excessive CPU usage
